      ...
      <Layout>
        <div className="w-full max-w-xl space-y-8">
          <div>
            ...
            <p className="text-muted-foreground text-[15px] mt-1">Only administrators can change settings.</p>
          </div>
          <div className="border rounded-xl bg-card p-5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-bold bg-accent text-muted-foreground px-2.5 py-1 rounded-lg uppercase tracking-wider">User</span>
            </div>
          </div>
        </div>
      </Layout>
  ...
  return (
    <Layout>
      <div className="w-full max-w-xl space-y-8">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">Settings</h1>
          <p className="text-muted-foreground text-[15px] mt-1">Site configuration and access control.</p>
        </div>
